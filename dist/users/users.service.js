...
let UsersService = class UsersService {
    ...
    async getAllUsers() {
        return await this.userRepository
            ...
            .catch((e) => {
            throw new common_1.HttpException('Неудалось получить пользователей', common_1.HttpStatus.BAD_REQUEST);
        });
    }
    async addUser(userDto) {
        await this.userRepository.insert(userDto).catch((e) => {
            throw new common_1.HttpException('Невозможно добавить данного пользователя', common_1.HttpStatus.BAD_REQUEST);
        });
