...
__decorate([
    (0, swagger_1.ApiProperty)({ example: 'admin@gmail.com', description: 'Почта юзера' }),
...
__decorate([
    ...
    (0, class_validator_1.Length)(3, 20, { message: 'Не меньше 3 и не больше 20' }),
    __metadata("design:type", String)
], RegisterUserDto.prototype, "username", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ example: 'admin', description: 'Пароль пользователя' }),
    (0, class_validator_1.Length)(4, 20, { message: 'Не меньше 4 и не больше 20' }),
    __metadata("design:type", String)
